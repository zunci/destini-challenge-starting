...
class StoryBrain {
  ...
  //Step 25 - Change the storyNumber property into a private property so that only story_brain.dart has access to it. You can do this by right clicking on the name (storyNumber)
  ...
  //Step 17 - Create a method called nextStory(), it should not have any outputs
  //but it should have 1 input called choiceNumber which will be the choice number (int) made by the user.
  void nextStory({int choiceNumber}) {
    ...
    //e.g. if choiceNumber was equal to 1 and the storyNumber is 0, the storyNumber should become 1.
    if (_storyNumber == 0) {
      if (choiceNumber == 1) {
        _storyNumber = 2;
      } else {
  ...
  bool buttonShouldBeVisible() => getChoice2() == '' ? false : true;
}
